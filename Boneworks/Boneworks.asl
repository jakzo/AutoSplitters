...
init{
	...
	vars.loadingPointer = scanner.Scan(new SigScanTarget(3, "4889??????????488B??????????48FF????488B??????????488B??4889??????????488D??????????488B??????????48FF??????????????????????????????488B??????????418B") { 
	...
	vars.isLoading = new MemoryWatcher<bool>(new DeepPointer(vars.loadingPointer,0xC54));
